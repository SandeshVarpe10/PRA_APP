...
exports.saveCategory = async (req, res) => {
  try {
    ...
    const result = await productmodel.saveCategory(
      categoryName,
      categoryDescription
    );
...
exports.liveSearch = (req, res) => {
  ...
  productmodel
    .searchProductss(searchTerm, categoryId)
    .then((products) => {
      res.json(products);
    })
    .catch((err) => {
...
exports.saveSubCategory = async (req, res) => {
  try {
    ...
    let result = await productmodel.addSubCategory(
      subCategoryName,
      image,
      categoryId
    );
...
exports.viewSubCategory = async (req, res) => {
  ...
  try {
    ...
    // fetch subcategories
    let subcategories = await productmodel.getSubCategoriesByCategoryId(
      categoryId
    );
...
exports.deleteSubCatByID = async (req, res) => {
  try {
    ...
    const subcategories = await productmodel.getSubCategoriesByCategoryId(
      categoryId
    );
...
exports.updateSubCategorySave = async (req, res) => {
  ...
  try {
    ...
    const currentSubcategory = await productmodel.getSubCategoryById(
      subcategoryId
    );
    ...
    if (result && result.affectedRows > 0) {
      const updatedSubcategory = await productmodel.getSubCategoryById(
        subcategoryId
      );
      res.json({
        success: true,
...
exports.searchLiveProductById = async (req, res) => {
  ...
  try {
    const products = await productmodel.searchLiveProductsById(
      query,
      subcategoryId
    );
